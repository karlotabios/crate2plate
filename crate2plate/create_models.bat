...
rails g model Admin admin_email:string admin_username:string admin_password:string
rails g model Customer customer_email:string customer_username:string customer_password:string
