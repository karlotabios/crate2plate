...
Rails.application.config.assets.precompile = ['*.js', '*.css', '*.css.erb', '*.min.js', '*.min.css', '*.min.css.erb']
...
# Rails.application.config.assets.precompile += %w( bootstrap.min.css.erb )
...
# Rails.application.config.assets.precompile += %w( style.css.erb )
